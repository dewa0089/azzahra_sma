                    ...
                    <form class="forms-sample" method="POST" action="{{ route('mobiler.update', $mobiler->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="asal_usul">
                                ...
                                <option value="Yayasan" {{ $mobiler->asal_usul == 'Yayasan' ? 'selected' : '' }}>Yayasan</option>
                                <option value="Sekolah" {{ $mobiler->asal_usul == 'Sekolah' ? 'selected' : '' }}>Sekolah</option>
                                <option value="JPS Guru" {{ $mobiler->asal_usul == 'JPS Guru' ? 'selected' : '' }}>JPS Guru</option>
                                <option value="SPP" {{ $mobiler->asal_usul == 'SPP' ? 'selected' : '' }}>SPP</option>
                            </select>

                            <select class="form-control" name="cara_peroleh">
                                <option value="">-- Pilih Cara Peroleh --</option>
                                <option value="Beli" {{ $mobiler->cara_peroleh == 'Beli' ? 'selected' : '' }}>Beli</option>
                                <option value="Sekolah" {{ $mobiler->cara_peroleh == 'Sekolah' ? 'selected' : '' }}>Sekolah</option>
                                <option value="Yayasan" {{ $mobiler->cara_peroleh == 'Yayasan' ? 'selected' : '' }}>Yayasan</option>
                                <option value="Hadiah" {{ $mobiler->cara_peroleh == 'Hadiah' ? 'selected' : '' }}>Hadiah</option>
                            </select>
