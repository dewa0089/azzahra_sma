...
@section('content')
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Inventaris Barang Mobiler</h4>
                    <p class="card-description">
                        Tambah Barang Mobiler
                    </p>
                    <form class="forms-sample" method="POST" action="{{ route('mobiler.store') }}" enctype="multipart/form-data">
                        @csrf
