      ...
      <div class="card-body">
        <div class="row mb-1">
          ...
          <div class="col text-end d-flex align-items-end justify-content-end">
            <a href="{{ route('lainnya.trash') }}" class="btn btn-warning mdi mdi-archive btn-icon-prepend mr-2">
                Data Terhapus
             </a> 
         ...
         <div class="row ml-1">
    <form action="{{ route('lainnya.index') }}" method="GET" class="d-flex">
...
@empty
<tr>
  <td colspan="13" class="text-center">Tidak ada data Barang Lainnya.</td>
</tr>
@endforelse
